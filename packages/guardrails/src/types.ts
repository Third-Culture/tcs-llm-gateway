/**
 * Type definitions for the TCS no-op guardrails stub. These mirror the API
 * surface of the upstream proprietary `ee/guardrails` package so that callers
 * compile unchanged, but no proprietary content-filtering logic is shipped.
 * The stub is a no-op: every request passes.
 */
import type {
	GuardrailAction,
	SystemRuleConfig,
